...
export const translations = {
  ...
  en: {
    ...
    ai: {
      cta: 'AI photo mode',
      title: 'AI Photo Mode',
      intro: 'Upload or take a photo of food waste. PlateWise AI describes what it sees and suggests an action. It cannot confirm food safety.',
      ...
      disclaimer: 'AI-assisted guidance only. PlateWise cannot confirm food safety.',
      ...
      errNotConfigured: 'AI Photo Mode is not configured yet. You can still use curated AR Scan or Demo Mode.',
    },
    images: {
      title: 'Scan images',
  ...
  ms: {
    ...
    ai: {
      cta: 'Mod foto AI',
      title: 'Mod Foto AI',
      intro: 'Muat naik atau ambil foto sisa makanan. PlateWise AI menerangkan apa yang dilihatnya dan mencadangkan tindakan. Ia tidak boleh mengesahkan keselamatan makanan.',
      ...
      disclaimer: 'Panduan berbantukan AI sahaja. PlateWise tidak boleh mengesahkan keselamatan makanan.',
      ...
      errNotConfigured: 'Mod Foto AI belum dikonfigurasikan lagi. Anda masih boleh menggunakan Imbasan AR terpilih atau Mod Demo.',
    },
    images: {
      title: 'Imej imbasan',
  ...
  'zh-CN': {
    ...
    ai: {
      cta: 'AI 照片模式',
      title: 'AI 照片模式',
      intro: '上传或拍摄食物浪费的照片。PlateWise AI 会描述它看到的内容并建议一个行动。它无法确认食物是否安全食用。',
      chooseLabel: '选择或拍摄照片',
      takePhoto: '拍摄照片',
      chooseImage: '选择图片',
      changePhoto: '更换照片',
      ...
      disclaimer: '仅为 AI 辅助建议。PlateWise 无法确认食物是否安全食用。',
      ...
      errNotConfigured: 'AI 照片模式尚未配置。你仍然可以使用指定图片 AR 扫描或演示模式。',
    },
    images: {
      title: '扫描图片',
